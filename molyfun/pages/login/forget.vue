		...
		<view class="uni-main">			
			<view class="login-box">
				<view class="uni-form-item uni-column">
					...
					<view class="with-fun">
						<input class="uni-input input-lines" placeholder="请输入您的预留手机号码" :value="phoneValue" @input="clearInput" />
				...
				<view class="login-btn main-bg-ab8 main-text-fff" @click="savePass">
					完成
				</view>
			</view>
		</view>
